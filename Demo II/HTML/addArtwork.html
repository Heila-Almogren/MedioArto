        ...
        <form id="addArtworkForm" onsubmit="return false;">
            <table id="GeneralInformation" style="text-align: left; margin: auto; width:400px;">
                ...
                <tr>
                    ...
                    <td>
                        <input type="file" accept="image/*" id="date" name="date" accept="application/msexcel" style="font-size: 17px;" required>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input type="number" min="0" max="60" step="5" id="date" name="date" accept="application/msexcel" style="font-size: 17px;" required>
                    </td>
                </tr>
                <tr>
                    <td>
