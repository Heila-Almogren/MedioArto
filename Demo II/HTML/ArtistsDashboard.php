        ...
        $(document).ready(function() {
            ...
            $(".deleteIcon").click(function() {
                ...
                if (confirm("are you sure you want to delete this artwork?")) {
                    ...
                    /*here is the php code of deleting artwork*/
                }
            ...
            $(".editIcon").click(function() {
                window.open("About-Guest.html") //replace this link with the link of editing the artwork
            });
        });
        ...
        <tr style="200px;">
            <td style="background-color: white; padding: 0px; width: 300px; min-width: 300px; height: 200px; text-align: center;">
                <div id="profilePhotoDiv" style="height: 100%; background-color: dodgerblue; border-bottom-right-radius: 30px;">
                    <img src="Images/Neutral-placeholder-profile.jpg" style="height: 200px; width: 200px; border-radius: 50%; margin-top:20px; margin-bottom: 20px;">
                </div>
                ...
                <div id="myProfile" ; style="margin-left: 50px; font-family: 'Muli-Reg'; font-size: 20px;">
                    <form>
                        <table>
                            ...
                            <tr>
                                <td>Image</td>
                                <td><input type="file" name="photo" class="InputStyle" id="3"></td>
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="firstname" placeholder="First Name" value="Muhammed" maxlength="15" class="InputStyle" id="1"></td>

                            </tr>
                            <tr>
                                <td>Last Name</td>
                                <td><input type="text" name="lastname" maxlength="15" class="InputStyle" placeholder="Last name" id="2" value="Khalid"></td>

                            </tr>
                            <tr>
                                <td>First Name</td>
                                <td><input type="text" name="Username" maxlength="15" class="InputStyle" placeholder="Username" id="3" value="MK99"></td>

                            </tr>

                            <tr>
                                <td style=" vertical-align: top; padding-top: 15px;">Description</td>
                                <td><textArea type="text" name="description" maxlength="200" class="InputStyle" placeholder="Write a short description about yourself here" id="3" style="height:200px; max-height:200px; width:500px; max-width:500px;" style="width: auto; min-width: 100px;">Hello, I'm Muhammed from Saud Arabia.. I love crafting and football and video games</textArea></td>
                ...
                <div class="myArtwork" ; style="margin-left: 40px; margin-right: 40px; font-family: 'Muli-Reg'; font-size: 20px; display:none;">
                    ...
                    <div class="inline" style="width:200px; height:200px; margin: 60px;">
                        <div class="artworkImage" style="height: 180px; width: 180px; border-radius:50%; background-image: url('Images/ArtWorks/6-tin-can-felt-monsters.jpg'); text-align: center; opacity:1; background-size: contain; position: relative; margin: auto;">
                            ...
                            <div class='innerTools' style='display:none; height: 100%; width: 100%; background: rgba(255, 255, 255, 0.5); border-radius: 50%; '><img class='editIcon' src='Images/edit.png' style='margin-top: 70px; height: 30px; width: 30px;'>&nbsp; &nbsp; <img class='deleteIcon' src='Images/remove.png' style='margin-top: 70px; height: 40px; width: 30px;  '></div>
