...
header("location:addMsg.php?id='".$_SESSION['artistid']."'") ;	    
    }
?>
...
?>
    ...
    <div id="mainDiv" style="min-height: 550px; height: auto; width: 500px; margin:auto; margin-top: 100px; margin-bottom: 50px; background-color: #D3D3D3; border-radius: 30px; vertical-align: middle; text-align: center; ">
        <form  method="post" id="addArtworkForm"  >
            <table id="GeneralInformation" style="text-align: left; margin: auto; width:400px;">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="title" name="add_title" placeholder="like: car using old paper" style="font-size: 17px;" required>
                    </td>
                </tr>
                ...
                <tr>
					...
					<input type="file" name="add_image" id="insert" style="font-size: 17px;"  />
                ...
                <tr>
                    <td>
                        <p class="fieldTitle">Time needed (in minutes):</p>
                    </td>
                    <td>
                        <input type="number" min="0" max="60" step="5" id="date" name="add_time" accept="application/msexcel" style="font-size: 17px;" required>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input type="date" id="date" name="add_date" accept="application/msexcel" style="font-size: 17px;" required>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                ...
                <tr>
                    <td colspan="2">
                        ...
                        <input type="textarea" name="add_des" style="height: 150px; text-align: left;  font-size: 17px" placeholder="give a brief decription about your work like the main idea or the general use.. but don't include the steps or any detailed information!" required>
                    </td>
                </tr>
                <tr>
                    <td colspan="2" style="text-align: right; height: 80px;">
                        <input  type ="button"style="border: none; border-radius: 10px; height: 40px; width: 80px; color: dimgrey; font-size: 22px; outline: none;  background-color: darkgrey; " class="fieldTitle" onclick="validateGeneral()"value="NEXT">
                    </td>
                </tr>
            </table>
            ...
            <table id="Ingredients" style="text-align: left; margin: auto; width:400px; font-family: ' Muli-Reg'; display: none;">
                ...
                <tr id="addI">
                    <td style="text-align: left; width: 50px;">
                        <button class="addIngre" type="button" name="item" onclick="removeItem('addIngreField'); addIngredient()">+
                            </button>
                    </td>
                    <td>
            ...
            <table id="Steps" style="width: 450px;  margin: auto; font-family: 'Muli-Reg'; display:none;">
                ...
                <tbody style="text-align: left;">
                    ...
                    <tr id="addS" style="height:50px;">
						...
						<input id="addStepField" type="text" maxlength="90" style="outline: none;  border-radius: 20px; font-size: 15px; height: 30px; width: 95%; border: none; text-align:left"></td>
                    </tr>
                    <tr id="noCount">
                    ...
                    <tr style="text-align: right;">
                        <td colspan="3" style="height: 80px; text-align: center;">
                            <button type="submit" name="sub" id="sub" style="border: none; border-radius: 15px; height: 40px; width: 100px; color: dimgrey; font-size: 22px; outline: none; background-color: darkgrey;" class="fieldTitle" onclick="validateStep(); ">DONE!</button>
