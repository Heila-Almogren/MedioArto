...
?>">
        ...
        <a class="active" href="AllArtworks.php?id=<?php
echo  $_SESSION['visitorid'];
?>">
...
?>'><div class='ProfileOption edit' style='color:black;'>&#128100; &nbsp; View Account</div></a>";
      ...
      <p class="featuredArtTitle">ALL ARTWORKS</p><br>
       <div id= "featuredImg" style="margin: auto; text-align: center;">
      <!--
           <figure>
                ...
                $result = mysqli_query($conn, $query);
                 if (mysqli_num_rows($result) > 0) 
                 {
                    while ($data = mysqli_fetch_row($result)) {
                        print "<figure> <a href='Artifact.php?id=" . $data[0] . "'> <img class='featuredImg' src='" . $data[1] . "'> </a></figure> ";
                    }
                }
                else {
