...
function check($a_userName , $a_email){
    ...
    /*$upload_pdf=rand(1000,10000)."-".$_FILES['prevArt']['name'];
	$tname=$_FILES['prevArt']['tmp_name'];
	$uploads_dir='/Demo/HTML/pdf';
    move_uploaded_file($tname,$uploads_dir.'/'.$upload_pdf);*/
  ...
  if( in_array($imageFileType,$extensions_arr) ){
   ...
   if(check($a_userName,$a_email)){
    $sql="INSERT INTO artist(artistUsername,password,Email,Fname,Lname,telephone,previousWork)VALUES('$a_userName','$a_password','$a_email','$a_firstName','$a_lastName','$a_telephone','$name')";
                    ...
                    <div>
                       ...
                       <div class="uploadFile">
                            ...
                            <div class="uploadAlias" style="text-align: center; display: flex;">
                                ...
                                <div class="tooltip">Optional: art portfolio (pdf):
                                    <span class="tooltiptext">We'd like to some of your cool previous artworks! collect them in a pdf file and upload them here </span>
                                </div>

               <input type="hidden" name="MAX_FILE_SIZE" value="200000" /> 
			   <input type="file" name="prevArt" />
										   
										   
                               <!-- <input type="file" name="prevArt" class="InputStyle" id="6" accept=".pdf" > -->
